...
//  
//  The code will take input image and style images and resize them to equal shapes
//  then load a pre-trained CNN, seperate the layers of content and style and work on both
//  independently, and then minimize the losses ( content, style, total variation)
//  Finally, we set our gradients and optimize with L-BGFS algorithm
// 
//
// ***********************************************************************
